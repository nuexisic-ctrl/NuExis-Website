...
// Import images
// NOTE: img3 filename is 'VC Bar3.webp' (no space before 3)
import mainImage from '@/images/Products/VC Bar/VC Bar 5.webp';
import img1 from '@/images/Products/VC Bar/VC Bar 1.webp';
import img2 from '@/images/Products/VC Bar/VC Bar 2.webp';
import img3 from '@/images/Products/VC Bar/VC Bar3.webp';
import img4 from '@/images/Products/VC Bar/VC Bar 4.webp';

const allImages = [mainImage, img1, img2, img3, img4];

const VCBarPage: React.FC = () => {
            ...
            <div className="min-h-screen bg-gray-50 pt-16 pb-8">
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                        ...
                        {/* Header - More Compact */}
                        <div className="px-5 py-6 border-b border-gray-200 bg-gray-50/50">
                            <span className="inline-block px-2 py-0.5 bg-brand-blue/10 text-brand-blue text-xs font-semibold rounded mb-2">
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        A premium all-in-one video conferencing bar designed to transform huddle rooms and small meeting spaces into professional collaboration hubs with crystal-clear audio and video.
                                    </p>
