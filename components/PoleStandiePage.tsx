...
// Import images
import mainImage from '@/images/Products/Pole Standie/Pole Standie 5.webp';
import img1 from '@/images/Products/Pole Standie/Pole Standie 1.webp';
import img2 from '@/images/Products/Pole Standie/Pole Standie 2.webp';
import img3 from '@/images/Products/Pole Standie/Pole Standie 3.webp';
import img4 from '@/images/Products/Pole Standie/Pole Standie 4.webp';
import img6 from '@/images/Products/Pole Standie/Pole Standie 6.webp';

const allImages = [mainImage, img1, img2, img3, img4, img6];

const PoleStandiePage: React.FC = () => {
        ...
        <>
            <div className="min-h-screen bg-gray-50 pt-16 pb-8">
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    {/* Back Button */}
                    <div className="mb-3">
                        <Link to="/product" className="inline-flex items-center text-gray-600 hover:text-brand-blue transition-colors text-xs font-medium">
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                        ...
                        <div className="px-5 py-3 border-b border-gray-200 bg-gray-50/50">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">
                                Premium Pole Standee Display Unit
                            </h1>
                        </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Professional pole standee display for retail, exhibitions, and corporate environments.
                                    </p>
...
export default PoleStandiePage;
