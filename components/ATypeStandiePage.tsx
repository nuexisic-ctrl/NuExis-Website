...
// Import images
import mainImage from '@/images/Products/A Type Standie/A Type Standie 6.webp';
import img1 from '@/images/Products/A Type Standie/A Type Standie 1.webp';
import img2 from '@/images/Products/A Type Standie/A Type Standie 2.webp';
import img3 from '@/images/Products/A Type Standie/A Type Standie 3.webp';
import img4 from '@/images/Products/A Type Standie/A Type Standie 4.webp';
import img5 from '@/images/Products/A Type Standie/A Type Standie 5.webp';

const allImages = [mainImage, img1, img2, img3, img4, img5];

const ATypeStandiePage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Professional A-frame digital standee for high-visibility displays in retail spaces, events, and promotional campaigns.
                                    </p>
...
export default ATypeStandiePage;
