...
// Import images
import mainImage from '@/images/Products/Digital Audio Signal Processor/Digital Audio Signal Processor 3.webp';
import img1 from '@/images/Products/Digital Audio Signal Processor/Digital Audio Signal Processor 1.webp';
import img2 from '@/images/Products/Digital Audio Signal Processor/Digital Audio Signal Processor 2.webp';

const allImages = [mainImage, img1, img2];

const DigitalAudioSignalProcessorPage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-3">
                                    ...
                                    <div className="relative mb-2">
                                        ...
                                        >
                                            <img
                                                src={activeImage}
                                                alt="Digital Audio Signal Processor"
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Advanced digital signal processing unit for professional audio management in conference rooms and auditoriums.
                                    </p>
                ...
                {isFullscreen && (
                    ...
                    >
                        ...
                        >
                            <img
                                src={activeImage}
                                alt="Digital Audio Signal Processor - Fullscreen"
...
export default DigitalAudioSignalProcessorPage;
