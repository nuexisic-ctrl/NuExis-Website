...
// Import images
import mainImage from '@/images/Products/Wireless Microphones/Wireless Microphones 4.webp';
import img1 from '@/images/Products/Wireless Microphones/Wireless Microphones 1.webp';
import img2 from '@/images/Products/Wireless Microphones/Wireless Microphones 2.webp';
import img3 from '@/images/Products/Wireless Microphones/Wireless Microphones 3.webp';
import img5 from '@/images/Products/Wireless Microphones/Wireless Microphones 5.webp';
import img6 from '@/images/Products/Wireless Microphones/Wireless Micrphoness 5.webp';

const allImages = [mainImage, img1, img2, img3, img5, img6];

const WirelessMicrophonesPage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Professional wireless microphone system delivering crystal-clear audio quality and reliable performance for events, conferences, and stage performances.
                                    </p>
                ...
                {isFullscreen && (
                    ...
                    >
                        ...
                        >
                            <img
                                src={activeImage}
                                alt="Wireless Microphones - Fullscreen"
...
export default WirelessMicrophonesPage;
