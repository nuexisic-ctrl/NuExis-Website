  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      <button
        ...
        className="group flex items-center justify-center p-3 sm:p-4 bg-green-500 text-white rounded-full shadow-[0_4px_14px_0_rgba(34,197,94,0.39)] hover:shadow-[0_6px_20px_rgba(34,197,94,0.23)] hover:-translate-y-1 hover:bg-green-600 transition-all duration-300 transform focus:outline-none focus:ring-4 focus:ring-green-300 relative"
      ...
      >
        ...
        <svg
          ...
          height="28"
          fill="currentColor"
          className="bi bi-whatsapp w-7 h-7 sm:w-8 sm:h-8 drop-shadow-md"
          viewBox="0 0 16 16"
        >
