...
// Import images
import mainImage from '@/images/Products/Digital Touch Delegate Microphone/Digital Touch Delegate Microphone 3.webp';
import img1 from '@/images/Products/Digital Touch Delegate Microphone/Digital Touch Delegate Microphone 1.webp';
import img2 from '@/images/Products/Digital Touch Delegate Microphone/Digital Touch Delegate Microphone 2.webp';
import img4 from '@/images/Products/Digital Touch Delegate Microphone/Digital Touch Delegate Microphone 4.webp';

const allImages = [mainImage, img1, img2, img4];

const DigitalTouchDelegateMicrophonePage: React.FC = () => {
                    ...
                    <div className="bg-white rounded-xl shadow-md overflow-hidden border border-gray-200">
                        ...
                        <div className="px-5 py-3 border-b border-gray-200 bg-gray-50/50">
                            ...
                            <h1 className="text-xl font-bold text-gray-900">
                                Digital Touch Delegate Microphone
                            </h1>
                        </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-3">
                                    ...
                                    <div className="relative mb-2">
                                        ...
                                        >
                                            <img
                                                src={activeImage}
                                                alt="Digital Touch Delegate Microphone"
                                    ...
                                    <div className="flex gap-1.5 justify-start overflow-x-auto">
                                        {allImages.map((img, idx) => (
                                            <button
                                                ...
                                                className={`flex-shrink-0 w-16 h-16 rounded-md overflow-hidden border transition-all ${activeImage === img
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Advanced digital touch delegate microphone unit designed for modern conference systems, offering crystal clear audio and intuitive touch controls.
                                    </p>
                ...
                {isFullscreen && (
                    ...
                    >
                        ...
                        >
                            <img
                                src={activeImage}
                                alt="Digital Touch Delegate Microphone - Fullscreen"
...
export default DigitalTouchDelegateMicrophonePage;
