...
// Import images
import mainImage from '@/images/Products/Wooden Display Podium/Wooden Display Podium 4.webp';
import img1 from '@/images/Products/Wooden Display Podium/Wooden Display Podium 1.webp';
import img2 from '@/images/Products/Wooden Display Podium/Wooden Display Podium 2.webp';
import img3 from '@/images/Products/Wooden Display Podium/Wooden Display Podium 3.webp';
import img5 from '@/images/Products/Wooden Display Podium/Wooden Display Podium 5.webp';
import img6 from '@/images/Products/Wooden Display Podium/Wooden Display Podium 6.webp';

const allImages = [mainImage, img1, img2, img3, img5, img6];

const WoodenDisplayPodiumPage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Executive wooden podium with premium finish for high-profile presentations, boardrooms, and executive offices.
                                    </p>
                ...
                {isFullscreen && (
                    ...
                    >
                        ...
                        >
                            <img
                                src={activeImage}
                                alt="Wooden Display Podium - Fullscreen"
...
export default WoodenDisplayPodiumPage;
