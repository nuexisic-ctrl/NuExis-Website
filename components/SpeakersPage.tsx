...
// Import images
import mainImage from '@/images/Products/Speakers/Speakers 4.webp';
import img1 from '@/images/Products/Speakers/Speakers 1.webp';
import img2 from '@/images/Products/Speakers/Speakers2.webp';
import img3 from '@/images/Products/Speakers/Speakers 3.webp';
import img5 from '@/images/Products/Speakers/Speakers 5.webp';
import img6 from '@/images/Products/Speakers/Speakers 6.webp';
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Professional audio speakers designed for high-fidelity sound reproduction in conference rooms and auditoriums.
                                    </p>
