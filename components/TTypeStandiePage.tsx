...
// Import images
import mainImage from '@/images/Products/T Type Standie/T Type Standie 4.webp';
import img1 from '@/images/Products/T Type Standie/T Type Standie 1.webp';
import img2 from '@/images/Products/T Type Standie/T Type Standie 2.webp';
import img3 from '@/images/Products/T Type Standie/T Type Standie 3.webp';

const allImages = [mainImage, img1, img2, img3];

const TTypeStandiePage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Sleek T-shaped digital standee offering a modern and minimalist display solution for information kiosks and wayfinding.
                                    </p>
...
export default TTypeStandiePage;
