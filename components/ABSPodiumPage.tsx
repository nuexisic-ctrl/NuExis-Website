...
// Import images
import img1 from '@/images/Products/ABS-Podium/ABS Studio 1.webp';
import img2 from '@/images/Products/ABS-Podium/ABS Studio 2.webp';
import img3 from '@/images/Products/ABS-Podium/ABS Studio 3.webp';
import img4 from '@/images/Products/ABS-Podium/ABS Studio 4.webp';
import img5 from '@/images/Products/ABS-Podium/ABS Studio 5.webp';

const allImages = [img1, img2, img3, img4, img5];
const mainImage = img1;

const ABSPodiumPage: React.FC = () => {
        ...
        <>
            <div className="min-h-screen bg-gray-50 pt-16 pb-8">
                <div className="max-w-5xl mx-auto px-4">
                    ...
                    {/* Back Button */}
                    <div className="mb-3">
                        <Link to="/digital-podium" className="inline-flex items-center text-gray-600 hover:text-brand-blue transition-colors text-xs font-medium">
                            <ArrowLeft className="w-3.5 h-3.5 mr-1" />
                            Back to Digital Podiums
                        </Link>
                    </div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Durable and lightweight ABS Digital Podium, perfect for modern classrooms and lecture halls.
                                    </p>
