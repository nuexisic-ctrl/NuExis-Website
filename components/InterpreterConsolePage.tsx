...
// Import images
import mainImage from '@/images/Products/Interpreter Console/Interpreter Console 4.webp';
import img1 from '@/images/Products/Interpreter Console/Interpreter Console 1.webp';
import img2 from '@/images/Products/Interpreter Console/Interpreter Console 2.webp';
import img3 from '@/images/Products/Interpreter Console/Interpreter Console 3.webp';
import img5 from '@/images/Products/Interpreter Console/Interpreter Console 5.webp';

const allImages = [mainImage, img1, img2, img3, img5];

const InterpreterConsolePage: React.FC = () => {
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-5 gap-4">
                                ...
                                <div className="lg:col-span-2 flex flex-col">
                                    <p className="text-xs text-gray-600 mb-3 leading-relaxed">
                                        Professional interpreter console for simultaneous multi-language translation in conferences and international meetings.
                                    </p>
                ...
                {isFullscreen && (
                    ...
                    >
                        ...
                        >
                            <img
                                src={activeImage}
                                alt="Interpreter Console - Fullscreen"
...
export default InterpreterConsolePage;
